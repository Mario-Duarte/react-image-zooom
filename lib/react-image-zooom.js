...
var react_1 = __webpack_require__(94);
...
function ImageZoom(_a) {
  var _b = _a.zoom,
    ...
    onError = _a.onError,
    _g = _a.errorContent,
    errorContent = _g === void 0 ? (0, jsx_runtime_1.jsx)(ErrorText, {
      children: "There was a problem loading your image"
    }) : _g;
  var _h = (0, react_1.useState)(false),
    isZoomed = _h[0],
    setIsZoomed = _h[1];
  var _j = (0, react_1.useState)("50% 50%"),
    position = _j[0],
    setPosition = _j[1];
  ...
  var _k = (0, useImageLoader_1["default"])(src, onError),
    imgData = _k.imgData,
    error = _k.error,
    naturalWidth = _k.naturalWidth;
...
var external_commonjs_react_commonjs2_react_amd_React_root_React_ = __webpack_require__(94);
