...
function useCalculateZoom(zoom, fullWidth, naturalWidth, containerRef) {
  return (0, react_1.useMemo)(function () {
    ...
    var containerWidth = ((_a = containerRef === null || containerRef === void 0 ? void 0 : containerRef.current) === null || _a === void 0 ? void 0 : _a.clientWidth) || 0;
...
function usePreventBodyScroll(isZoomed, elm) {
  ...
  (0, react_1.useEffect)(function () {
    var element = elm === null || elm === void 0 ? void 0 : elm.current;
    if (!element) return;
...
function useZoomPosition(figureRef) {
  return (0, react_1.useCallback)(function (e) {
    ...
    var zoomer = figureRef.current.getBoundingClientRect();
    var x, y;
...
function ImageZoom(_a) {
  ...
  var zoomInPosition = (0, useZoomPosition_1["default"])(figureRef);
  var isTouchEventRef = (0, react_1.useRef)(false);
  (0, usePreventBodyScroll_1["default"])(isZoomed, figureRef);
  var _k = (0, useImageLoader_1["default"])(src, onError),
    imgData = _k.imgData,
    error = _k.error,
    naturalWidth = _k.naturalWidth;
  var calculateZoom = (0, useCalculateZoom_1["default"])(zoom, fullWidth, naturalWidth, figureRef);
