(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["ReactImageZooom"] = factory(require("react"));
	else
		root["ReactImageZooom"] = factory(root["React"]);
...
function useCalculateZoom(zoom, fullWidth, naturalWidth, containerRef) {
  return (0, react_1.useMemo)(function () {
    if (!fullWidth || !naturalWidth) return "".concat(zoom, "%");
    var containerWidth = (containerRef === null || containerRef === void 0 ? void 0 : containerRef.clientWidth) || 0;
    if (!containerWidth) return "".concat(zoom, "%");
    var zoomPercentage = naturalWidth / containerWidth * 100;
    return "".concat(zoomPercentage < 100 ? zoom : zoomPercentage, "%");
  }, [zoom, fullWidth, naturalWidth, containerRef]);
}
exports["default"] = useCalculateZoom;
...
var react_1 = __webpack_require__(156);
function useImageLoader(src, onError) {
...
exports["default"] = useImageLoader;
...
var react_1 = __webpack_require__(156);
function usePreventBodyScroll(isZoomed, elm) {
  (0, react_1.useEffect)(function () {
    var originalOverflow = getComputedStyle(document.body).overflow || "auto";
    if (isZoomed) {
  ...
  (0, react_1.useEffect)(function () {
    ...
    if (isZoomed) {
      elm.addEventListener("touchmove", preventScroll, {
        passive: false
      });
    }
    return function () {
...
var react_1 = __webpack_require__(156);
function useZoomPosition(figureRef) {
  return (0, react_1.useCallback)(function (e) {
    if (!figureRef) return;
    var zoomer = figureRef.getBoundingClientRect();
    var x, y;
    ...
    return "".concat(Math.max(0, Math.min(x, 100)), "% ").concat(Math.max(0, Math.min(y, 100)), "%");
  }, [figureRef]);
}
exports["default"] = useZoomPosition;
...
var jsx_runtime_1 = __webpack_require__(848);
var react_1 = __webpack_require__(156);
var styled_components_1 = __importStar(__webpack_require__(945));
var usePreventBodyScroll_1 = __importDefault(__webpack_require__(109));
var useCalculateZoom_1 = __importDefault(__webpack_require__(745));
var useZoomPosition_1 = __importDefault(__webpack_require__(116));
var useImageLoader_1 = __importDefault(__webpack_require__(228));
var rotate = (0, styled_components_1.keyframes)(templateObject_1 || (templateObject_1 = __makeTemplateObject(["\n    from { transform: rotate(0deg); }\n    to { transform: rotate(360deg); }\n"], ["\n    from { transform: rotate(0deg); }\n    to { transform: rotate(360deg); }\n"])));
var Figure = styled_components_1["default"].figure(templateObject_2 || (templateObject_2 = __makeTemplateObject(["\n  position: relative;\n  display: inline-block;\n  width: auto;\n  min-height: ", ";\n  background-position: 50% 50%;\n  background-color: #eee;\n  margin: 0;\n  overflow: hidden;\n  cursor: ", ";\n  user-select: none;\n\n  &:before {\n    content: \"\";\n    background-color: transparent;\n    position: absolute;\n    top: 0;\n    left: 0;\n    right: 0;\n    width: 100%;\n    height: 100%;\n    opacity: ", ";\n    transition: opacity 0.2s ease-in-out;\n    z-index: 1;\n  }\n  &:after {\n    content: \"\";\n    position: absolute;\n    top: calc(50% - 25px);\n    left: calc(50% - 25px);\n    width: 50px;\n    height: 50px;\n    border-radius: 50%;\n    border: 5px solid transparent;\n    border-top-color: #333;\n    border-right-color: #333;\n    border-bottom-color: #333;\n    animation: ", " 2s linear infinite;\n    opacity: ", ";\n    transition: opacity 0.2s ease-in-out;\n    z-index: 2;\n  }\n"], ["\n  position: relative;\n  display: inline-block;\n  width: auto;\n  min-height: ", ";\n  background-position: 50% 50%;\n  background-color: #eee;\n  margin: 0;\n  overflow: hidden;\n  cursor: ", ";\n  user-select: none;\n\n  &:before {\n    content: \"\";\n    background-color: transparent;\n    position: absolute;\n    top: 0;\n    left: 0;\n    right: 0;\n    width: 100%;\n    height: 100%;\n    opacity: ", ";\n    transition: opacity 0.2s ease-in-out;\n    z-index: 1;\n  }\n  &:after {\n    content: \"\";\n    position: absolute;\n    top: calc(50% - 25px);\n    left: calc(50% - 25px);\n    width: 50px;\n    height: 50px;\n    border-radius: 50%;\n    border: 5px solid transparent;\n    border-top-color: #333;\n    border-right-color: #333;\n    border-bottom-color: #333;\n    animation: ", " 2s linear infinite;\n    opacity: ", ";\n    transition: opacity 0.2s ease-in-out;\n    z-index: 2;\n  }\n"])), function (_a) {
  var $isLoaded = _a.$isLoaded;
  return $isLoaded ? "auto" : "25vh";
}, function (_a) {
  var $isZoomed = _a.$isZoomed;
...
var Img = styled_components_1["default"].img(templateObject_4 || (templateObject_4 = __makeTemplateObject(["\n  opacity: ", ";\n  display: block;\n"], ["\n  opacity: ", ";\n  display: block;\n"])), function (_a) {
  var $isZoomed = _a.$isZoomed;
  return $isZoomed ? "0" : "1";
});
function ImageZoom(_a) {
  var _b = _a.zoom,
    zoom = _b === void 0 ? "200" : _b,
    _c = _a.fullWidth,
    fullWidth = _c === void 0 ? false : _c,
    _d = _a.alt,
    alt = _d === void 0 ? "This is an imageZoom image" : _d,
    _e = _a.width,
    width = _e === void 0 ? "100%" : _e,
    _f = _a.height,
    height = _f === void 0 ? "auto" : _f,
    src = _a.src,
    id = _a.id,
  ...
  var _g = (0, react_1.useState)(false),
    isZoomed = _g[0],
    setIsZoomed = _g[1];
  var _h = (0, react_1.useState)("50% 50%"),
    position = _h[0],
    setPosition = _h[1];
  var figureRef = (0, react_1.useRef)(null);
  var zoomInPosition = (0, useZoomPosition_1["default"])(figureRef.current);
  var isTouchEventRef = (0, react_1.useRef)(false);
  (0, usePreventBodyScroll_1["default"])(isZoomed, figureRef.current);
  var _j = (0, useImageLoader_1["default"])(src, onError),
    imgData = _j.imgData,
    error = _j.error,
    naturalWidth = _j.naturalWidth;
  var calculateZoom = (0, useCalculateZoom_1["default"])(zoom, fullWidth, naturalWidth, figureRef.current);
  var toggleZoom = function toggleZoom(e, isTouchEvent, isZoomed, setIsZoomed, setPosition, zoomInPosition) {
    if (isTouchEvent) {
      isTouchEventRef.current = true;
    }
    var newIsZoomed = !isZoomed;
    setIsZoomed(newIsZoomed);
    var newPosition = newIsZoomed ? zoomInPosition(e) : "50% 50%";
    if (newPosition) {
      setPosition(newPosition);
    }
  };
  var updatePosition = function updatePosition(e, isZoomed, setPosition, zoomInPosition) {
    if (isZoomed) {
      var newPosition = zoomInPosition(e);
      if (newPosition) {
        setPosition(newPosition);
      }
    }
  ...
  var figureStyle = (0, react_1.useMemo)(function () {
    return {
      backgroundImage: "url(".concat(isZoomed && imgData ? imgData : "", ")"),
      backgroundSize: calculateZoom,
      backgroundPosition: position
    };
  }, [isZoomed, imgData, calculateZoom, position]);
  if (error) return (0, jsx_runtime_1.jsx)(jsx_runtime_1.Fragment, {
    children: (0, react_1.isValidElement)(errorContent) ? errorContent : (0, jsx_runtime_1.jsx)(ErrorText, {
      children: "There was a problem loading your image"
    })
  });
  var figureClasses = [imgData ? "loaded" : "loading", isZoomed ? "zoomed" : "fullView", className].filter(Boolean).join(" ");
  return (0, jsx_runtime_1.jsx)(Figure, __assign({
    ref: figureRef,
    id: id,
    ...
    "$isZoomed": isZoomed,
    role: "button",
    "aria-label": "Zoomable image: ".concat(alt),
    tabIndex: 0
  }, {
    children: imgData && (0, jsx_runtime_1.jsx)(Img, {
      loading: "lazy",
      id: "imageZoom",
      src: imgData,
      alt: alt,
...
var external_commonjs_react_commonjs2_react_amd_React_root_React_ = __webpack_require__(156);
...
//# sourceMappingURL=react-image-zooom.js.map