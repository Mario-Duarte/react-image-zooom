...
class ImageZoom extends React.Component {
    ...
    render() {
        ...
        return (
            <Figure
                id={this.props.id}
                className={[figureClass, figureZoomed, this.props.className].join(" ")}
                style={{
                    backgroundImage: "url(" + this.state.imgData + ")",
                    backgroundSize: this.props.zoom + "%",
            ...
            >
                <Img
                    ...
                    alt={this.props.alt}
                    style={{ opacity: this.state.zoomed }}
