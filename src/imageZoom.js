...
class ImageZoom extends React.Component {
    ...
    render() {
        ...
        return(
            <Figure id={this.props.id} className={figureClass} style={{ backgroundImage: "url("+this.state.imgData+")", backgroundSize: this.props.zoom+"%", backgroundPosition: this.state.position }} onClick={ e => this.handleClick(e) } onMouseMove={ e => this.handleMove(e) } onMouseLeave={ () => this.handleLeave() }>
